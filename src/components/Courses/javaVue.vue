...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      question() {
        return this.questionBank.find(
          (item) => item.id == this.$route.params.id && item.name == "java"
        );
      },
      id() {
    ...
    methods: {
      ...
      next() {
        if (
          this.picked!=undefined && this.picked.toLowerCase() ===
          this.question.answer.toLowerCase()
        ) {
          this.$store.dispatch("setRightAnswers");
          console.log("Answer is correct ");
          this.previousSelcted=this.picked
          console.log(this.previousSelcted);
        } if (
          this.picked!=undefined  && this.picked!=this.previousSelcted&& this.picked.toLowerCase() !=
          this.question.answer.toLowerCase()
        ) {
          console.log(this.previousSelcted);
        ...
        this.$router.push(`/java/${this.id + 1}`);
